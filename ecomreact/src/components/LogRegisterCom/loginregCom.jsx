...
const RegisterUser=()=>{
    const serv = new RegistertHttpService('http://127.0.0.1:9009/api/userlogininfo/');
    ...
    const save=()=>{
        console.log(userReg.UserName)
         ...
         .then((response)=>{
            ...
            servInrole.postData({RowId:0,UserName:userReg.UserName,RoleName:'Admin'})
            .then((response)=>{console.log('User added successfully')}).catch((error)=>{
